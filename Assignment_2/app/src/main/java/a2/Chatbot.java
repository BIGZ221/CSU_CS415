 ...
 * conversation will consist of an alternating sequence of sentences, one from
 * the
...
interface Chatbot {
   ...
   *                     If this exception is thrown, the conversation will be
   *                     automatically restarted from scratch.
   */
